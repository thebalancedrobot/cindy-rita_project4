    ...
    1: [
      function(require, module, exports) {
        ...
        app.getRandomCountry = function() {
          app.country =
            app.countryArray[
              Math.floor(Math.random() * app.countryArray.length)
            ];
        ...
        app.getCountryInfo = function() {
          ...
          $.ajax({
            ...
            $.ajax({
              url:
                "https://api.darksky.net/forecast/93932fce8bfc18bf1b4f29a5f1695173/" +
                app.lat +
                "," +
                app.long +
                "?units=si",
              ...
              app.attractionsURL =
                "https://api.sygictravelapi.com/1.1/en/places/list";
              app.cityID = app.countries["" + app.country].cityID;
              $.ajax({
        ...
        app.displayCountry = function(country) {
          ...
          $(".grid__content--flights").html(
            '<div data-skyscanner-widget="LocationWidget" data-locale="en-GB" data-params="colour:#f4d35e;location:' +
              country.capital +
